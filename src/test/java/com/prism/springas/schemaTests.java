...
//    @Autowired
//    voiceExSchema voiceExSchema;

//    @Autowired
//    SyncVoiceSchema syncVoiceSchema;
//    @Test
...
//        System.out.println(selectEx());
    ...
    public String testMenu() throws Exception{
        ...
        sqlEngine.getParamEx("type",3);
        sqlEngine.getParamEx("roleId","780481ad96eb46f0b689ecac22dd2c5a");
//        return this.baseSchema.selectExPage("voice","getAddVoicePie",sqlEngine).toString();
//        sqlEngine.getParamEx("voiceCaseId","58375_RID3_010_SITEXDF_58375_03112019_085608_000135_0");
//        return voiceExSchema.getMinGroupSize("",sqlEngine);
//        List<BasePage> bb = syncVoiceSchema.getSyncAfterDate();
//        System.out.println("sqqq");
        return "sss";
    }
